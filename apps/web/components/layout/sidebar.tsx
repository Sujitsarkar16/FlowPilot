...
export const dashboardNavigation = [
  ...
  { href: "/dashboard/events", label: "Activity", icon: CalendarDays },
  { href: "/dashboard/standing-orders", label: "Automations", icon: ListTodo },
  { href: "/dashboard/approvals", label: "Review", icon: CheckSquare },
  { href: "/dashboard/connections", label: "Connected apps", icon: Plug },
  { href: "/dashboard/settings/autonomy", label: "What FlowPilot can do", icon: Shield },
