...
export const mockPlan: Plan = {
  ...
  summary: "Trip plan",
  planner_rationale: "Deterministic test plan.",
...
export const mockApproval: Approval = {
  ...
  action: { ...mockPlan.actions[0], status: "waiting_approval" },
};
export const mockOrder: StandingOrder = {
  id: "order-1",
  instruction: "Prepare every booked flight.",
  version: 1,
  enabled: true,
