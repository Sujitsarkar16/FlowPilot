...
export function ApprovalsManager() {
  ...
  return <div className="mx-auto max-w-5xl p-4 pb-24 sm:p-6 md:pb-8">
    <header className="mb-6 max-w-3xl"><h1 className="text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">Approvals</h1><p className="mt-2 text-sm leading-6 text-slate-600">Review the action, its risk, and the data it needs before PulseOS continues.</p></header>
